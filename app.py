...
MODEL_LIBRARY = {
    "Azuki (红豆)": {
        "Casual (便服)": {"path": "model/azuki-casual.pure.psb", "config": "azuki-config.js"},
        "Dress (礼服)": {"path": "model/azuki-dress.pure.psb", "config": "azuki-config.js"},
        "Maid (女仆装)": {"path": "model/azuki-maid.pure.psb", "config": "azuki-config.js"},
        "Santa (圣诞装)": {"path": "model/azuki-santa.pure.psb", "config": "azuki-config.js"},
        "Teenage (少女)": {"path": "model/azuki-teenage.pure.psb", "config": "azuki-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/azuki-wintermaid.pure.psb", "config": "azuki-config.js"},
        "Winter (冬装)": {"path": "model/azuki-winter.pure.psb", "config": "azuki-config.js"},
        "Yukata (浴衣)": {"path": "model/azuki-yukata.pure.psb", "config": "azuki-config.js"},
    },
    "Chocola (巧克力)": {
        "Casual (便服)": {"path": "model/chocola-casual.pure.psb", "config": "chocola-config.js"},
        "Dress (礼服)": {"path": "model/chocola-dress.pure.psb", "config": "chocola-config.js"},
        "Koneko (幼年)": {"path": "model/chocola-koneko.pure.psb", "config": "kochocola-config.js"},
        "Lolita (洛丽塔)": {"path": "model/chocola-lolita.pure.psb", "config": "chocola-config.js"},
        "Maid (女仆装)": {"path": "model/chocola-maid.pure.psb", "config": "chocola-config.js"},
        "Pajama (睡衣)": {"path": "model/chocola-pajama.pure.psb", "config": "chocola-config.js"},
        "Santa (圣诞装)": {"path": "model/chocola-santa.pure.psb", "config": "chocola-config.js"},
        "Teenage (少女)": {"path": "model/chocola-teenage.pure.psb", "config": "chocola-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/chocola-wintermaid.pure.psb", "config": "chocola-config.js"},
        "Winter (冬装)": {"path": "model/chocola-winter.pure.psb", "config": "chocola-config.js"},
        "Yukata (浴衣)": {"path": "model/chocola-yukata.pure.psb", "config": "chocola-config.js"},
    },
    "Cinnamon (桂皮)": {
        "Casual (便服)": {"path": "model/cinnamon-casual.pure.psb", "config": "cinnamon-config.js"},
        "Dress (礼服)": {"path": "model/cinnamon-dress.pure.psb", "config": "cinnamon-config.js"},
        "Maid (女仆装)": {"path": "model/cinnamon-maid.pure.psb", "config": "cinnamon-config.js"},
        "Santa (圣诞装)": {"path": "model/cinnamon-santa.pure.psb", "config": "cinnamon-config.js"},
        "Teenage (少女)": {"path": "model/cinnamon-teenage.pure.psb", "config": "cinnamon-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/cinnamon-wintermaid.pure.psb", "config": "cinnamon-config.js"},
        "Winter (冬装)": {"path": "model/cinnamon-winter.pure.psb", "config": "cinnamon-config.js"},
        "Yukata (浴衣)": {"path": "model/cinnamon-yukata.pure.psb", "config": "cinnamon-config.js"},
    },
    "Coconut (椰子)": {
        "Casual (便服)": {"path": "model/coconut-casual.pure.psb", "config": "coconut-config.js"},
        "Dress (礼服)": {"path": "model/coconut-dress.pure.psb", "config": "coconut-config.js"},
        "Koneko (幼年)": {"path": "model/coconut-koneko.pure.psb", "config": "kococonut-config.js"},
        "Maid (女仆装)": {"path": "model/coconut-maid.pure.psb", "config": "coconut-config.js"},
        "Pajama (睡衣)": {"path": "model/coconut-pajama.pure.psb", "config": "coconut-config.js"},
        "Santa (圣诞装)": {"path": "model/coconut-santa.pure.psb", "config": "coconut-config.js"},
        "Teenage (少女)": {"path": "model/coconut-teenage.pure.psb", "config": "coconut-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/coconut-wintermaid.pure.psb", "config": "coconut-config.js"},
        "Winter (冬装)": {"path": "model/coconut-winter.pure.psb", "config": "coconut-config.js"},
        "Yukata (浴衣)": {"path": "model/coconut-yukata.pure.psb", "config": "coconut-config.js"},
    },
    "Maple (枫)": {
        "Casual (便服)": {"path": "model/maple-casual.pure.psb", "config": "maple-config.js"},
        "Dress (礼服)": {"path": "model/maple-dress.pure.psb", "config": "maple-config.js"},
        "Maid (女仆装)": {"path": "model/maple-maid.pure.psb", "config": "maple-config.js"},
        "Santa (圣诞装)": {"path": "model/maple-santa.pure.psb", "config": "maple-config.js"},
        "Teenage (少女)": {"path": "model/maple-teenage.pure.psb", "config": "maple-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/maple-wintermaid.pure.psb", "config": "maple-config.js"},
        "Winter (冬装)": {"path": "model/maple-winter.pure.psb", "config": "maple-config.js"},
        "Yukata (浴衣)": {"path": "model/maple-yukata.pure.psb", "config": "maple-config.js"},
    },
    "Vanilla (香草)": {
        "Casual (便服)": {"path": "model/vanilla-casual.pure.psb", "config": "vanilla-config.js"},
        "Dress (礼服)": {"path": "model/vanilla-dress.pure.psb", "config": "vanilla-config.js"},
        "Koneko (幼年)": {"path": "model/vanilla-koneko.pure.psb", "config": "kovanilla-config.js"},
        "Lolita (洛丽塔)": {"path": "model/vanilla-lolita.pure.psb", "config": "vanilla-config.js"},
        "Maid (女仆装)": {"path": "model/vanilla-maid.pure.psb", "config": "vanilla-config.js"},
        "Pajama (睡衣)": {"path": "model/vanilla-pajama.pure.psb", "config": "vanilla-config.js"},
        "Santa (圣诞装)": {"path": "model/vanilla-santa.pure.psb", "config": "vanilla-config.js"},
        "Teenage (少女)": {"path": "model/vanilla-teenage.pure.psb", "config": "vanilla-config.js"},
        "WinterMaid (冬女仆)": {"path": "model/vanilla-wintermaid.pure.psb", "config": "vanilla-config.js"},
        "Winter (冬装)": {"path": "model/vanilla-winter.pure.psb", "config": "vanilla-config.js"},
        "Yukata (浴衣)": {"path": "model/vanilla-yukata.pure.psb", "config": "vanilla-config.js"},
    },
    "Milk (牛奶)": {
        "Teenage (少女)": {"path": "model/milk-teenage.pure.psb", "config": "milk-config.js"},
        "Winter (冬装)": {"path": "model/milk-winter.pure.psb", "config": "milk-config.js"},
    },
    "Fraise (草莓)": {
        "Maid (女仆装)": {"path": "model/fraise-maid.pure.psb", "config": "fraise-config.js"},
    }
}
