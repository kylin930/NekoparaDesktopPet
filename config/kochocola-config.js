    ...
    bust: [
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/b01.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/b02.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kochocola/b03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 3, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kochocola/b04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/b05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: 'わくわく',
          audio: "./sounds/kochocola/b06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    eye: [
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/h04.wav",
          variables: [
    ...
    face: [
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/h01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kochocola/h02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 4, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kochocola/h03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/h05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: '戸惑い',
          audio: "./sounds/kochocola/h06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    pant: [
      {
        reaction: {
          ...
          audio: "./sounds/kochocola/u01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kochocola/u02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kochocola/u03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kochocola/u04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kochocola/u05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
