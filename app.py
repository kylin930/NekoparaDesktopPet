...
MODEL_LIBRARY = {
    "Azuki (红豆)": {
        "Casual (便服)": {"path": "models/azuki-casual.pure.psb.zip", "config": "azuki-config.js"},
        "Dress (礼服)": {"path": "models/azuki-dress.pure.psb.zip", "config": "azuki-config.js"},
        "Maid (女仆装)": {"path": "models/azuki-maid.pure.psb.zip", "config": "azuki-config.js"},
        "Santa (圣诞装)": {"path": "models/azuki-santa.pure.psb.zip", "config": "azuki-config.js"},
        "Teenage (少女)": {"path": "models/azuki-teenage.pure.psb.zip", "config": "azuki-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/azuki-wintermaid.pure.psb.zip", "config": "azuki-config.js"},
        "Winter (冬装)": {"path": "models/azuki-winter.pure.psb.zip", "config": "azuki-config.js"},
        "Yukata (浴衣)": {"path": "models/azuki-yukata.pure.psb.zip", "config": "azuki-config.js"},
        "Koneko (幼年)": {"path": "models/azuki-koneko.pure.psb.zip", "config": "koazuki-config.js"},
    },
    "Chocola (巧克力)": {
        "Casual (便服)": {"path": "models/chocola-casual.pure.psb.zip", "config": "chocola-config.js"},
        "Dress (礼服)": {"path": "models/chocola-dress.pure.psb.zip", "config": "chocola-config.js"},
        "Lolita (洛丽塔)": {"path": "models/chocola-lolita.pure.psb.zip", "config": "chocola-config.js"},
        "Maid (女仆装)": {"path": "models/chocola-maid.pure.psb.zip", "config": "chocola-config.js"},
        "Pajama (睡衣)": {"path": "models/chocola-pajama.pure.psb.zip", "config": "chocola-config.js"},
        "Santa (圣诞装)": {"path": "models/chocola-santa.pure.psb.zip", "config": "chocola-config.js"},
        "Teenage (少女)": {"path": "models/chocola-teenage.pure.psb.zip", "config": "chocola-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/chocola-wintermaid.pure.psb.zip", "config": "chocola-config.js"},
        "Winter (冬装)": {"path": "models/chocola-winter.pure.psb.zip", "config": "chocola-config.js"},
        "Yukata (浴衣)": {"path": "models/chocola-yukata.pure.psb.zip", "config": "chocola-config.js"},
        "Koneko (幼年)": {"path": "models/chocola-koneko.pure.psb.zip", "config": "kochocola-config.js"},
    },
    "Cinnamon (桂皮)": {
        "Casual (便服)": {"path": "models/cinnamon-casual.pure.psb.zip", "config": "cinnamon-config.js"},
        "Dress (礼服)": {"path": "models/cinnamon-dress.pure.psb.zip", "config": "cinnamon-config.js"},
        "Maid (女仆装)": {"path": "models/cinnamon-maid.pure.psb.zip", "config": "cinnamon-config.js"},
        "Santa (圣诞装)": {"path": "models/cinnamon-santa.pure.psb.zip", "config": "cinnamon-config.js"},
        "Teenage (少女)": {"path": "models/cinnamon-teenage.pure.psb.zip", "config": "cinnamon-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/cinnamon-wintermaid.pure.psb.zip", "config": "cinnamon-config.js"},
        "Winter (冬装)": {"path": "models/cinnamon-winter.pure.psb.zip", "config": "cinnamon-config.js"},
        "Yukata (浴衣)": {"path": "models/cinnamon-yukata.pure.psb.zip", "config": "cinnamon-config.js"},
        "Koneko (幼年)": {"path": "models/cinnamon-koneko.pure.psb.zip", "config": "kocinnamon-config.js"},
    },
    "Coconut (椰子)": {
        "Casual (便服)": {"path": "models/coconut-casual.pure.psb.zip", "config": "coconut-config.js"},
        "Dress (礼服)": {"path": "models/coconut-dress.pure.psb.zip", "config": "coconut-config.js"},
        "Maid (女仆装)": {"path": "models/coconut-maid.pure.psb.zip", "config": "coconut-config.js"},
        "Pajama (睡衣)": {"path": "models/coconut-pajama.pure.psb.zip", "config": "coconut-config.js"},
        "Santa (圣诞装)": {"path": "models/coconut-santa.pure.psb.zip", "config": "coconut-config.js"},
        "Teenage (少女)": {"path": "models/coconut-teenage.pure.psb.zip", "config": "coconut-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/coconut-wintermaid.pure.psb.zip", "config": "coconut-config.js"},
        "Winter (冬装)": {"path": "models/coconut-winter.pure.psb.zip", "config": "coconut-config.js"},
        "Yukata (浴衣)": {"path": "models/coconut-yukata.pure.psb.zip", "config": "coconut-config.js"},
        "Koneko (幼年)": {"path": "models/coconut-koneko.pure.psb.zip", "config": "kococonut-config.js"},
    },
    "Maple (枫)": {
        "Casual (便服)": {"path": "models/maple-casual.pure.psb.zip", "config": "maple-config.js"},
        "Dress (礼服)": {"path": "models/maple-dress.pure.psb.zip", "config": "maple-config.js"},
        "Maid (女仆装)": {"path": "models/maple-maid.pure.psb.zip", "config": "maple-config.js"},
        "Santa (圣诞装)": {"path": "models/maple-santa.pure.psb.zip", "config": "maple-config.js"},
        "Teenage (少女)": {"path": "models/maple-teenage.pure.psb.zip", "config": "maple-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/maple-wintermaid.pure.psb.zip", "config": "maple-config.js"},
        "Winter (冬装)": {"path": "models/maple-winter.pure.psb.zip", "config": "maple-config.js"},
        "Yukata (浴衣)": {"path": "models/maple-yukata.pure.psb.zip", "config": "maple-config.js"},
        "Koneko (幼年)": {"path": "models/maple-koneko.pure.psb.zip", "config": "komaple-config.js"},
    },
    "Vanilla (香草)": {
        "Casual (便服)": {"path": "models/vanilla-casual.pure.psb.zip", "config": "vanilla-config.js"},
        "Dress (礼服)": {"path": "models/vanilla-dress.pure.psb.zip", "config": "vanilla-config.js"},
        "Lolita (洛丽塔)": {"path": "models/vanilla-lolita.pure.psb.zip", "config": "vanilla-config.js"},
        "Maid (女仆装)": {"path": "models/vanilla-maid.pure.psb.zip", "config": "vanilla-config.js"},
        "Pajama (睡衣)": {"path": "models/vanilla-pajama.pure.psb.zip", "config": "vanilla-config.js"},
        "Santa (圣诞装)": {"path": "models/vanilla-santa.pure.psb.zip", "config": "vanilla-config.js"},
        "Teenage (少女)": {"path": "models/vanilla-teenage.pure.psb.zip", "config": "vanilla-config.js"},
        "WinterMaid (冬女仆)": {"path": "models/vanilla-wintermaid.pure.psb.zip", "config": "vanilla-config.js"},
        "Winter (冬装)": {"path": "models/vanilla-winter.pure.psb.zip", "config": "vanilla-config.js"},
        "Yukata (浴衣)": {"path": "models/vanilla-yukata.pure.psb.zip", "config": "vanilla-config.js"},
        "Koneko (幼年)": {"path": "models/vanilla-koneko.pure.psb.zip", "config": "kovanilla-config.js"},
    },
    "Milk (牛奶)": {
        "Teenage (少女)": {"path": "models/milk-teenage.pure.psb.zip", "config": "milk-config.js"},
        "Winter (冬装)": {"path": "models/milk-winter.pure.psb.zip", "config": "milk-config.js"},
        "Koneko (幼年)": {"path": "models/milk-koneko.pure.psb.zip", "config": "komilk-config.js"},
    },
    "Fraise (草莓)": {
        "Maid (女仆装)": {"path": "models/fraise-maid.pure.psb.zip", "config": "fraise-config.js"},
    }
}
