    ...
    bust: [
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/b01.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/b02.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kocinnamon/b03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 3, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kocinnamon/b04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/b05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: 'わくわく',
          audio: "./sounds/kocinnamon/b06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    eye: [
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/h04.wav",
          variables: [
    ...
    face: [
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/h01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kocinnamon/h02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 4, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kocinnamon/h03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/h05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: '戸惑い',
          audio: "./sounds/kocinnamon/h06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    pant: [
      {
        reaction: {
          ...
          audio: "./sounds/kocinnamon/u01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kocinnamon/u02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kocinnamon/u03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kocinnamon/u04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kocinnamon/u05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
