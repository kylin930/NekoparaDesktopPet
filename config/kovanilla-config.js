    ...
    bust: [
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/b01.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/b02.wav",
          variables: [
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kovanilla/b03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 3, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: 'びっくり1',
          audio: "./sounds/kovanilla/b04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/b05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: 'わくわく',
          audio: "./sounds/kovanilla/b06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    eye: [
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/h04.wav",
          variables: [
    ...
    face: [
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/h01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや2',
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kovanilla/h02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 4, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot2: '首横振り',
          audio: "./sounds/kovanilla/h03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/h05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'いやいや',
          diffTimelineSlot2: '戸惑い',
          audio: "./sounds/kovanilla/h06.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
    ...
    pant: [
      {
        reaction: {
          ...
          audio: "./sounds/kovanilla/u01.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kovanilla/u02.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kovanilla/u03.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kovanilla/u04.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
      ...
      },
      {
        reaction: {
          ...
          diffTimelineSlot1: 'はじらい',
          diffTimelineSlot2: 'ひく',
          audio: "./sounds/kovanilla/u05.wav",
          variables: [
            { name: 'face_mouth', value: 30, duration: 500 },
            { name: 'face_talk', value: 1, duration: 500 }
          ]
